...
namespace IF_P工伤医保.baseCode
{
    public static class bas门特业务
    {
        ...
        public static string KDo门特医生工作站_临床查询辅检报告(object pCtrl, string vs业务类别, long vl辅检申请序号, long vl婴儿序号)
        {
            try
            {
                #region 正常返回以下XML数据
        ...
        public static bool KDo门特医生工作站_临床调阅原始报告(object pCtrl, long vl辅检申请序号)
        {
            try
            {
